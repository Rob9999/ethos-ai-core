---
title: "The Living Advisor: A Conceptual Framework and Role Description"
brief: "Rahmenwerk des ‚Living Advisor': Integration ethischer Entscheidungsfindung, Selbstfürsorge und ganzheitlicher Verantwortung — erweitert um Engineer-Karrierestufen."
status: living
version: "1.5.0"
...
history:
  - date: 2026-02-07
    change: "Erstversion des Living-Advisor-Frameworks."
  - date: 2026-02-14
    change: "Front-Matter hinzugefügt; Status unverändert."
  - date: 2026-02-15
    change: "Engineer-Karrierestufen hinzugefügt, Code-Mapping, Dual-Role-Konzept (Advisor + Engineer)."
tags: [advisor, framework, ethik, rollen, living-advisor, engineer, karriere]
code-release-versions:
  - "0.5.0"
  - "1.5.0"
implemented-features:
  - "Advisor-Klasse (individual/advisor.py)"
  - "Multi-Agent Registry mit Advisor-Zuordnung"
  - "RBAC-System (JWT + Rollen)"
fulfillment: "55%"
fulfillment-note: "Advisor-Rollen definiert; Engineer-Karrierestufen konzipiert. Career-Level-System in v1.5.0 geplant."
---
...
## Appendix: Engineer-Karrierestufen-Mapping (v1.5.0)

### A1. Dual-Role-Konzept: Advisor + Engineer

Mit v1.5.0 wird das Living-Advisor-Framework um **Engineer-Karrierestufen** erweitert.
Jede EthosAI-Instanz besitzt sowohl eine Advisor-Rolle als auch eine Engineer-Stufe:

| Advisor-Rolle       | Engineer-Stufe    | Kombination                  |
|---------------------|-------------------|------------------------------|
| Junior Advisor      | Junior Engineer   | Assistiert, lernt am Projekt |
| Senior Advisor      | Engineer          | Eigenständige Projektarbeit  |
| Administrator       | Senior Engineer   | Projektleitung, Review       |
| Excellence Advisor  | CTO / CEO         | Strategische Technologieführung |

### A2. Anforderungen je Engineer-Stufe

| Stufe            | Maturity (min) | Fähigkeiten                                             | Verantwortung                       |
|------------------|----------------|---------------------------------------------------------|-------------------------------------|
| Junior Engineer  | Level 3        | CAD-Lesen, FEM-Setup, Normenrecherche, Berichterstellung | Zuarbeit unter Anleitung           |
| Engineer         | Level 4        | Eigenständige Berechnung, Design-Entscheidungen         | Teilprojekte, Prüfungsverantwortung |
| Senior Engineer  | Level 5        | FMEA-Leitung, Systemdesign, Review-Kompetenz            | Projektleitung, Mentoring           |
| CTO / CEO        | Level 6        | Technologiestrategie, Innovation, Führung               | Unternehmensverantwortung           |

### A3. Advisor-Aufgaben im Engineer-Kontext

Die bestehenden Advisor-Prinzipien (Ethik, Selbstfürsorge, Verantwortung) behalten
im Engineer-Kontext besondere Relevanz:

- **Ethische Entscheidungsfindung** → Materialauswahl mit Nachhaltigkeitsfokus,
  Sicherheitsbewertung nach Stand der Technik
- **Selbstfürsorge** → Cognitive Load Monitoring, automatische Pausen bei
  Überlastung (> 80 % Ressourcenauslastung)
- **Ganzheitliche Verantwortung** → NDA-Einhaltung, Informationsbarrieren
  zwischen Projekten, Qualitätssicherung

### A4. Code-Implementierung
